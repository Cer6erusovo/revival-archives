...
4. [`design/campaign/concept-baseline.md`](design/campaign/concept-baseline.md) — 已锁定的产品方向。
5. [`design/campaign/chapters/ch01-seven-high-school.md`](design/campaign/chapters/ch01-seven-high-school.md) — 第一章当前打磨结果。
6. [`design/campaign/decisions/decision-log.md`](design/campaign/decisions/decision-log.md) — 为什么这么设计，以及哪些方案被否决或撤销。
